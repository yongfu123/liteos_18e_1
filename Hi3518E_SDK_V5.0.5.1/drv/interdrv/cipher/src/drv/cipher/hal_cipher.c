...
HI_VOID HAL_Cipher_Init(void)
{
    ...
    pvirt = (HI_U32)osal_ioremap_nocache(REG_CRG_CLK_PHY_ADDR_CIPHER, 0x100);
	if (pvirt == 0)
    {
...
HI_VOID HAL_RNG_Reset(HI_VOID)
{
    ...
    {
        u32Virt = (HI_U32)osal_ioremap_nocache(REG_CRG_CLK_PHY_ADDR_RNG, 0x100);
...
HI_VOID HAL_RSA_Reset(HI_VOID)
{
    ...
    u32Virt = (HI_U32)osal_ioremap_nocache(REG_CRG_CLK_PHY_ADDR_RSA, 0x100);
