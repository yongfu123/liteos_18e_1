...
1.update the file:mpp/init/sdk_init.c
    modify the code in function sysctl_hi3518e as below to use the external audio codec.
    //himm( 0x201200E0, 0xd);//                   # internal codec£¬AIO MCLK out, CODEC AIO TX MCLK
    himm( 0x201200E0, 0xe);//             # external codec: AIC31£¬AIO MCLK out, CODEC AIO TX MCLK
    
    modify the code in function i2s_pin_mux as below to config pin mux
    ...
    modify the code in function pinmux_hi3518e as below to open i2s pin mux.
    //i2c0_pin_mux();
    i2c2_pin_mux();
    vicap_pin_mux();
    i2s_pin_mux();
