...
static __inline HI_VOID hi_ext_system_drc_manual_localmixingbright_write(HI_U8 data) {
    IOWR_8DIRECT(0x11B12, data);
}
static __inline HI_U8 hi_ext_system_drc_manual_localmixingbright_read(HI_VOID) {
    return IORD_8DIRECT(0x11B12);
}

static __inline HI_VOID hi_ext_system_drc_auto_localmixingbright_write(HI_U8 data) {
    IOWR_8DIRECT(0x11B13, data);
}
static __inline HI_U8 hi_ext_system_drc_auto_localmixingbright_read(HI_VOID) {
...
static __inline HI_VOID hi_ext_system_drc_detail_mixing_thres_write(HI_U8 data) {
    IOWR_8DIRECT(0x11B16, data);
}
static __inline HI_U8 hi_ext_system_drc_detail_mixing_thres_read(HI_VOID) {
    return IORD_8DIRECT(0x11B16);
}

static __inline HI_VOID hi_ext_system_drc_var_spatial_write(HI_U8 data) {
    IOWR_8DIRECT(0x11B17, data);
}
static __inline HI_U8 hi_ext_system_drc_var_spatial_read(HI_VOID) {
    return IORD_8DIRECT(0x11B17);
}

static __inline HI_VOID hi_ext_system_drc_var_range_write(HI_U8 data) {
    IOWR_8DIRECT(0x11B18, data);
}
static __inline HI_U8 hi_ext_system_drc_var_range_read(HI_VOID) {
    return IORD_8DIRECT(0x11B18);
}

static __inline HI_VOID hi_ext_system_drc_actual_strength_write(HI_U8 data) {
    IOWR_8DIRECT(0x11B19, data);
}
static __inline HI_U8 hi_ext_system_drc_actual_strength_read(HI_VOID) {
    return IORD_8DIRECT(0x11B19);
}
