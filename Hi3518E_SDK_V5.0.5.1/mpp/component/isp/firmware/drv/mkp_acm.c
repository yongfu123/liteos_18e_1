...
static HI_U32 ACM_DRV_SplitArray(const HI_S16 * pstAcmCoefArray)
{
    ...
    osal_memcpy(&s16AcmLUT[0][0][0][0],pstAcmCoefArray,3*29*7*5*sizeof(HI_S16));
...
HI_VOID ACM_DRV_TransCoef(HI_VOID* pCoefMem, const ISP_ACM_LUTS_S* pstAcmCoef, ISP_ACM_MODE_E enAcmMode)
{
    ...
    osal_memcpy((HI_U8*)pCoefMem, stArray.stBit, stArray.u32Size); //memcpy copy to suppositional address
...
HI_S32 ACM_DRV_InitDefault(ISP_ACM_CTX_S* pstAcmCtx)
{
	...
	osal_memcpy(&(pstAcmCtx->pstCoefLut->stPqAcmModeBlue.as16Y) ,&s16AcmLUTDeflt[0][0][0][0],s32AcmCoefSize);
	osal_memcpy(&(pstAcmCtx->pstCoefLut->stPqAcmModeBlue.as16H) ,&s16AcmLUTDeflt[1][0][0][0],s32AcmCoefSize);
	osal_memcpy(&(pstAcmCtx->pstCoefLut->stPqAcmModeBlue.as16S) ,&s16AcmLUTDeflt[2][0][0][0],s32AcmCoefSize);

	osal_memcpy(&(pstAcmCtx->pstCoefLut->stPqAcmModeGreen.as16Y) ,&s16AcmLUTDeflt[0][0][0][0],s32AcmCoefSize);
	osal_memcpy(&(pstAcmCtx->pstCoefLut->stPqAcmModeGreen.as16H) ,&s16AcmLUTDeflt[1][0][0][0],s32AcmCoefSize);
	osal_memcpy(&(pstAcmCtx->pstCoefLut->stPqAcmModeGreen.as16S) ,&s16AcmLUTDeflt[2][0][0][0],s32AcmCoefSize);
	
	osal_memcpy(&(pstAcmCtx->pstCoefLut->stPqAcmModeBG.as16Y) ,&s16AcmLUTDeflt[0][0][0][0],s32AcmCoefSize);
	osal_memcpy(&(pstAcmCtx->pstCoefLut->stPqAcmModeBG.as16H) ,&s16AcmLUTDeflt[1][0][0][0],s32AcmCoefSize);
	osal_memcpy(&(pstAcmCtx->pstCoefLut->stPqAcmModeBG.as16S) ,&s16AcmLUTDeflt[2][0][0][0],s32AcmCoefSize);
	
	osal_memcpy(&(pstAcmCtx->pstCoefLut->stPqAcmModeSkin.as16Y) ,&s16AcmLUTDeflt[0][0][0][0],s32AcmCoefSize);
	osal_memcpy(&(pstAcmCtx->pstCoefLut->stPqAcmModeSkin.as16H) ,&s16AcmLUTDeflt[1][0][0][0],s32AcmCoefSize);
	osal_memcpy(&(pstAcmCtx->pstCoefLut->stPqAcmModeSkin.as16S) ,&s16AcmLUTDeflt[2][0][0][0],s32AcmCoefSize);
	
	osal_memcpy(&(pstAcmCtx->pstCoefLut->stPqAcmModeVivid.as16Y) ,&s16AcmLUTDeflt[0][0][0][0],s32AcmCoefSize);
	osal_memcpy(&(pstAcmCtx->pstCoefLut->stPqAcmModeVivid.as16H) ,&s16AcmLUTDeflt[1][0][0][0],s32AcmCoefSize);
	osal_memcpy(&(pstAcmCtx->pstCoefLut->stPqAcmModeVivid.as16S) ,&s16AcmLUTDeflt[2][0][0][0],s32AcmCoefSize);
...
HI_S32 ISP_ACM_DRV_SetCoeff(ISP_ACM_COEF_S *pstAcmCoef)
{
    ...
    osal_memcpy((HI_VOID*)pCoefAddr, (HI_VOID*)&pstAcmCoef->stLut, sizeof(ISP_ACM_LUT_S));
...
HI_S32 ISP_ACM_DRV_GetCoeff(ISP_ACM_COEF_S *pstAcmCoef)
{
    ...
    osal_memcpy((HI_VOID*)&pstAcmCoef->stLut, (HI_VOID*)pCoefAddr, sizeof(ISP_ACM_LUT_S));
    osal_up(&pstAcmCtx->stAcmSem);
...
HI_S32 ISP_ACM_DRV_Ioctrl(unsigned int cmd, unsigned long arg, void *private_data)
{
    ...
    switch (cmd)
    {
        ...
        {
            osal_memcpy(&g_stAcmCoef, argp,  sizeof(ISP_ACM_COEF_S));
            
            ISP_ACM_DRV_GetCoeff(&g_stAcmCoef);

            osal_memcpy(argp, &g_stAcmCoef, sizeof(ISP_ACM_COEF_S));
